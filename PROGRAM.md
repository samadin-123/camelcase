...
Improve the execution speed (operations per second) of the camelCase string conversion function. The metric measures throughput on a diverse test corpus including ASCII, Unicode, mixed case, and edge cases.

## What you CAN modify

- `index.js` — source code implementation
...
- `test.js` — test suite (ensures correctness)
